...
void Plot::setupDemo(int demoIndex)
{
  switch (demoIndex)
  {
...
void Plot::setupSimpleDemo(QCustomPlot *customPlot)
{
...
void Plot::setupSincScatterDemo(QCustomPlot *customPlot)
{
...
void Plot::setupScatterStyleDemo(QCustomPlot *customPlot)
{
...
void Plot::setupLineStyleDemo(QCustomPlot *customPlot)
{
...
void Plot::setupScatterPixmapDemo(QCustomPlot *customPlot)
{
...
void Plot::setupDateDemo(QCustomPlot *customPlot)
{
  demoName = "Date Demo";
...
void Plot::setupTextureBrushDemo(QCustomPlot *customPlot)
{
...
void Plot::setupMultiAxisDemo(QCustomPlot *customPlot)
{
...
void Plot::setupLogarithmicDemo(QCustomPlot *customPlot)
{
...
void Plot::setupRealtimeDataDemo(QCustomPlot *customPlot)
{
...
void Plot::setupParametricCurveDemo(QCustomPlot *customPlot)
{
...
void Plot::setupBarChartDemo(QCustomPlot *customPlot)
{
...
void Plot::setupStatisticalDemo(QCustomPlot *customPlot)
{
...
void Plot::setupSimpleItemDemo(QCustomPlot *customPlot)
{
...
void Plot::setupItemDemo(QCustomPlot *customPlot)
{
  demoName = "Item Demo";
...
void Plot::setupStyledDemo(QCustomPlot *customPlot)
{
...
void Plot::setupAdvancedAxesDemo(QCustomPlot *customPlot)
{
...
void Plot::setupColorMapDemo(QCustomPlot *customPlot)
{
...
void Plot::setupFinancialDemo(QCustomPlot *customPlot)
{
...
void Plot::setupPlayground(QCustomPlot *customPlot)
{
  Q_UNUSED(customPlot)
}
